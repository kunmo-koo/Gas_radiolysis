...
D = D .* 1e-6; % convert unit to um2/s 
...
for i = 1:400000
    if i<=399 || rem(i,100)==0
        ...
        semilogy(x,[plt(5,:);plt(1,:);plt(3,:);plt(2,:)],"LineWidth",1);
        line_color = ["#CC9900";"#F14040";"#00CECE";"#1A6FDF"];
        ...
        legend(name2(5),name2(1),name2(3),name2(2),'Location','southeastoutside');
...
f = [dCdx(1)+v*C(1)/D(1);dCdx(2)+v*C(2)/D(2);dCdx(3)+v*C(3)/D(3);dCdx(4)+v*C(4)/D(4);dCdx(5)+v*C(5)/D(5);dCdx(6)+v*C(6)/D(6);dCdx(7)+v*C(7)/D(7);dCdx(8)+v*C(8)/D(8)];
